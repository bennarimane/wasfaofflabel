        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mt-4 pt-2">
                    <h4 class="text-dark">Mes prescriptions</h4>
                </div>
            </div>
...
<a  href="{{ url('prescriptions/'.$prescription->id) }}">
                            <div class="col-lg-10">
                                <div class="job-list-desc candidates-profile-exp-desc">
                                    ...
                                    @if($prescription->demande == 1)  <span class="badge badge-warning">En attente</span>  @endif  <a href="{{ url('/modifier/prescription/'.$prescription->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </h5>
                                    <p class="text-muted mb-0 f-16"><i class="fas fa-bacterium"></i>  {{$prescription->path}}</p>
                                    <p class="text-muted mb-0 f-16"><i class="fas fa-capsules"></i> {{$prescription->nom_commercial}} </p>
