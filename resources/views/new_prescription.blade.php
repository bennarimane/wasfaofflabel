                ...
                <div class="col-lg-10">
                    <div class="rounded shadow bg-white p-4">
                        <div class="custom-form">
                            <div id="message3"></div>
                            <form method="post" action="{{ route('prescription.store') }}" name="contact-form" id="contact-form3">
                            {{ csrf_field() }}
                                <h4 class="text-dark mb-3">Etape 01: Publier une nouvelle prescription</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group app-label mt-2">
                                            <label class="text-muted">Titre de la prescription</label>
                                            <input id="company-name" type="text" class="form-control resume" placeholder="" name="titre" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <input  class="form-control" placeholder="" name ="poids" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            <label class="text-muted">Age</label>
                                            <input class="form-control" placeholder="" name ="age" required/>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                         <select id="select-country" class="demo-default" name="indication" required>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                        <select id="select-country" class="demo-default" name="quantite" required> 
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                        <select id="select-country" class="demo-default" name="unite" required>
  ...
  <div class="col-md-1">
                                      ...
                                      <div class="col-md-1">
                                        ...
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                              ...
                                              <input type="text" class="form-control resume" placeholder="5"  name="dure" required>           
                                        ...
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                        <select id="select-country" class="demo-default"  name="du" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <div class="form-button">
                                                        <select id="select-country" class="demo-default" name="type" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group app-label mt-2">
                                            ...
                                            <textarea id="description" rows="6" class="form-control resume" placeholder="" name ="description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-2">
                                        <input Type="submit" class="btn btn-primary" value="suivant >"></a>
                                    </div>
                                </div>
                            </form>
                        </div>
